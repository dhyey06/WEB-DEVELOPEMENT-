...
async function getSongs(folder) {
    currFolder = folder;
    let a = await fetch(`https://raw.githubusercontent.com/dhyey06/WEB-DEVELOPEMENT-/main/spotify-clone(84)/${currFolder}`);
...
const playMusic = (track, pause = false) => {
    currentsong.src = `https://raw.githubusercontent.com/dhyey06/WEB-DEVELOPEMENT-/main/spotify-clone(84)/${currFolder}/` + track;
    if (!pause) {
        currentsong.play()
...
async function displayAlbums() {
    let a = await fetch(`https://raw.githubusercontent.com/dhyey06/WEB-DEVELOPEMENT-/main/spotify-clone(84)/songs/`);
    let response = await a.text();
    let div = document.createElement("div");
    div.innerHTML = response;
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if (e.href.includes("/songs") && !e.href.includes(".htaccess")) {
            ...
            let a = await fetch(`https://raw.githubusercontent.com/dhyey06/WEB-DEVELOPEMENT-/main/spotify-clone(84)/songs/${folder}/info.json`);
            ...
            cardcontainer.innerHTML = cardcontainer.innerHTML + `<div data-folder="${folder}" class="card">
                        ...
                        <img src="https://raw.githubusercontent.com/dhyey06/WEB-DEVELOPEMENT-/main/spotify-clone(84)/songs/${folder}/cover.jpg" alt="Animal">
